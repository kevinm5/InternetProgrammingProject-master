<%@ Page Title="" Language="C#" MasterPageFile="~/NotAuthenticatedMasterPage.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
...
<section class="login-block">
  ...
  <div class="form-group">
    ...
    <div class="form-check">
        ...
        <asp:Button runat="server" class="btn btn-login btn-primary" Text="Submit" ID="btnLogin" OnClick="btnLogin_Click" />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InternetProgrammingProjectConnectionString2 %>" SelectCommand="SELECT * FROM [Note]"></asp:SqlDataSource>
        </div>
    </div>
</div>
  </div>
